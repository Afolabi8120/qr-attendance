                        ...
                        <div class="card-body ">
                           <div class="d-flex justify-content-between p-md-1">
                              <div class="d-flex flex-row">
                                 ...
                                 <div>
                                    <h4 class="txt">Lecturers</h4>
                                    <p class="mb-4 txt">Number of Lecturers</p>
                                 </div>
                              </div>
                              <div class="align-self-center">
                                 <h2 class="h1 mb-4"><?= $user->countByOneColumn('tbluser','usertype','Lecturer'); ?></h2>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="card-body ">
                           <div class="d-flex justify-content-between p-md-1">
                              <div class="d-flex flex-row">
                                 ...
                                 <div>
                                    <h4 class="txt">Admin</h4>
                                    <p class="mb-4 txt">Number of Admin</p>
                                 </div>
                              </div>
                              <div class="align-self-center">
                                 <h2 class="h1 mb-4"><?= $user->countByOneColumn('tbluser','usertype','Admin'); ?></h2>
                              </div>
                           </div>
                        </div>
                     </div>
