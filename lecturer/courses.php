                        ...
                        <table id="example1" class="table table-bordered">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td><?= $getCourseInfo->unit; ?></td>
                                 <td><?= $getCourse->level; ?></td>
                                 <td><?= $getCourse->program; ?></td>
                                 <td><?= $getCourse->semester; ?></td>
                                 <td><?= $getCourse->session; ?></td>
                                 <td class="text-center">
                                       <a href="take-attendance?id=<?= $getCourse->id; ?>" class="btn btn-info btn-sm" onclick="return confirm('Take Attendance?');"> Take Attendance </a>
                                 </td>
                              </tr>
                              <?php endforeach; ?>
                           </tbody>
